...
from .common import (DBlock, PreProcess, DiagMultivariateNormal as MultivariateNormal,
                     logsigma2cov, split_first_dim, merge_first_two_dims)
...
class RSSM(nn.Module, BaseModel):
    """
