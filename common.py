...
def obs2data_paths(objects, base):
    data_paths = []
    for name in objects['object']:
        path = os.path.join(base, name)
...
def get_eval_indice_dict(val_loss, val_rrse, val_rmse, val_pred_likelihood, val_multisample_rmse):
    eval_indice_dict = {
        "loss": val_loss,
        "rrse": val_rrse,
        "rmse": val_rmse,
        "pred_likelihood": val_pred_likelihood,
        "multisample_rmse": val_multisample_rmse
    }
    return eval_indice_dict
